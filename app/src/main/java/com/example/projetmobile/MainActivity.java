...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Enregistrer le BroadcastReceiver pour les actions CONNECTIVITY_ACTION et ACTION_AIRPLANE_MODE_CHANGED
    ...
    // Implémentez les méthodes d'interface du ConnectivityReceiverListener
    @Override
